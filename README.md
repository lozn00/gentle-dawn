...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/gentle-dawn
```

A live public deployment of this template is available at [https://gentle-dawn.templates.workers.dev](https://gentle-dawn.templates.workers.dev)
